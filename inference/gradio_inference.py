...
# 여기서부터 수정을 이어나가보도록 하자.
# 기본적으로 gradio_inference는 그냥 파이썬 노트북에서 진행하는 것처럼 하는 것 같음. 따라서 argparse를 사용하지 않고 해도 됌.
...
# 얘는 필요할 것 같음. 어찌 되든 간에 prompt file과 endpoint file은 불러와야 하니
